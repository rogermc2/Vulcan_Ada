...
package Vulkan.Extensions.KHR is
    ...
    type Pipeline_Binary is new Object_Handle;
    ...
    No_Pipeline_Binary: constant Pipeline_Binary :=
        Pipeline_Binary(System.Null_Address);
    ...
    package Pipeline_Binary_Vectors is
        new Ada.Containers.Vectors(Positive, Pipeline_Binary);

    -- Constants.
    Max_Global_Priority_Size: constant := 16;
    Max_Video_AV1_References_Per_Frame: constant := 7;
    Max_Pipeline_Binary_Key_Size: constant := 32;
    ...
    type Video_Encode_AV1_Prediction_Mode is (Intra_Only,
                                              Single_Reference,
                                              Unidirectional_Compound,
                                              Bidirectional_Compound)
        with Convention => C;

    for Video_Encode_AV1_Prediction_Mode'Size use 32;

    for Video_Encode_AV1_Prediction_Mode use (Intra_Only => 0,
                                              Single_Reference => 1,
                                              Unidirectional_Compound => 2,
                                              Bidirectional_Compound => 3);

    type Video_Encode_AV1_Rate_Control_Group is (Intra,
                                                 Predictive,
                                                 Bipredictive)
        with Convention => C;

    for Video_Encode_AV1_Rate_Control_Group'Size use 32;

    for Video_Encode_AV1_Rate_Control_Group use (Intra => 0,
                                                 Predictive => 1,
                                                 Bipredictive => 2);
    ...
    type Physical_Device_Layered_API is (API_Vulkan,
                                         API_D3D12,
                                         API_Metal,
                                         API_OpenGL,
                                         API_OpenGL_ES)
    ...
    for Physical_Device_Layered_API'Size use 32;

    for Physical_Device_Layered_API use (API_Vulkan => 0,
                                         API_D3D12 => 1,
                                         API_Metal => 2,
                                         API_OpenGL => 3,
                                         API_OpenGL_ES => 4);

    type Acceleration_Structure_Compatibility is (Compatible,
                                                  Incompatible)
        with Convention => C;

    for Acceleration_Structure_Compatibility'Size use 32;

    for Acceleration_Structure_Compatibility use (Compatible => 0,
                                                  Incompatible => 1);

    type Acceleration_Structure_Build_Type is (Host,
                                               Device,
                                               Host_Or_Device)
        with Convention => C;

    for Acceleration_Structure_Build_Type'Size use 32;

    for Acceleration_Structure_Build_Type use (Host => 0,
                                               Device => 1,
                                               Host_Or_Device => 2);

    type Address_Type is (Device, Host);
    ...
    type Video_Encode_AV1_Capability_Flags is new Flags;

    Video_Encode_AV1_Capability_No_Bit:
        constant Video_Encode_AV1_Capability_Flags := 0;
    Video_Encode_AV1_Capability_Per_Rate_Control_Group_Min_Max_Q_Index_Bit:
        constant Video_Encode_AV1_Capability_Flags := 16#00000001#;
    Video_Encode_AV1_Capability_Generate_OBU_Extension_Header_Bit:
        constant Video_Encode_AV1_Capability_Flags := 16#00000002#;
    Video_Encode_AV1_Capability_Primary_Reference_CDF_Only_Bit:
        constant Video_Encode_AV1_Capability_Flags := 16#00000004#;
    Video_Encode_AV1_Capability_Frame_Size_Override_Bit:
        constant Video_Encode_AV1_Capability_Flags := 16#00000008#;
    Video_Encode_AV1_Capability_Motion_Vector_Scaling_Bit:
        constant Video_Encode_AV1_Capability_Flags := 16#00000010#;

    type Video_Encode_AV1_Std_Flags is new Flags;

    Video_Encode_AV1_Std_No_Bit: constant Video_Encode_AV1_Std_Flags := 0;
    Video_Encode_AV1_Std_Uniform_Tile_Spacing_Flag_Set_Bit:
        constant Video_Encode_AV1_Std_Flags := 16#00000001#;
    Video_Encode_AV1_Std_Skip_Mode_Present_Unset_Bit:
        constant Video_Encode_AV1_Std_Flags := 16#00000002#;
    Video_Encode_AV1_Std_Primary_Ref_Frame_Bit:
        constant Video_Encode_AV1_Std_Flags := 16#00000004#;
    Video_Encode_AV1_Std_Delta_Q_Bit:
        constant Video_Encode_AV1_Std_Flags := 16#00000008#;

    type Video_Encode_AV1_Superblock_Size_Flags is new Flags;

    Video_Encode_AV1_Superblock_Size_No_Bit:
        constant Video_Encode_AV1_Superblock_Size_Flags := 0;
    Video_Encode_AV1_Superblock_Size_64_Bit:
        constant Video_Encode_AV1_Superblock_Size_Flags := 16#00000001#;
    Video_Encode_AV1_Superblock_Size_128_Bit:
        constant Video_Encode_AV1_Superblock_Size_Flags := 16#00000002#;

    type Video_Encode_AV1_Rate_Control_Flags is new Flags;

    Video_Encode_AV1_Rate_Control_No_Bit:
        constant Video_Encode_AV1_Rate_Control_Flags := 0;
    Video_Encode_AV1_Rate_Control_Regular_GOP_Bit:
        constant Video_Encode_AV1_Rate_Control_Flags := 16#00000001#;
    Video_Encode_AV1_Rate_Control_Temporal_Layer_Pattern_Dyadic_Bit:
        constant Video_Encode_AV1_Rate_Control_Flags := 16#00000002#;
    Video_Encode_AV1_Rate_Control_Reference_Pattern_Flat_Bit:
        constant Video_Encode_AV1_Rate_Control_Flags := 16#00000004#;
    Video_Encode_AV1_Rate_Control_Reference_Pattern_Dyadic_Bit:
        constant Video_Encode_AV1_Rate_Control_Flags := 16#00000008#;

    type Access_Flags_3 is new Flags_64;

    Access_Flags_3_None_Bit: constant Access_Flags_3 := 0;

    type Geometry_Instance_Flags is new Flags;

    Geometry_Instance_No_Bit: constant Geometry_Instance_Flags := 0;
    Geometry_Instance_Triangle_Facing_Cull_Disable_Bit:
        constant Geometry_Instance_Flags := 16#00000001#;
    Geometry_Instance_Triangle_Flip_Facing_Bit:
        constant Geometry_Instance_Flags := 16#00000002#;
    Geometry_Instance_Force_Opaque_Bit:
        constant Geometry_Instance_Flags := 16#00000004#;
    Geometry_Instance_Force_No_Opaque_Bit:
        constant Geometry_Instance_Flags := 16#00000008#;
    Geometry_Instance_Opacity_Micromaps_2_State_Bit:
        constant Geometry_Instance_Flags := 16#00000010#;
    Geometry_Instance_Disable_Opacity_Micromaps_Bit:
        constant Geometry_Instance_Flags := 16#00000020#;
    ...
    type Android_Surface_Create_Flags is new Flags;

    Android_Surface_Create_No_Bit: constant Android_Surface_Create_Flags := 0;
    ...
    -- Use with caution.
    type Peformance_Counter_Result
        (Storage: Performance_Counter_Storage := Int32) is
    record
        case Storage is
            when Int32 =>
    ...
    type Fragment_Shading_Rate_Combiner_Op_Array is
        array (1 .. 2) of aliased Fragment_Shading_Rate_Combiner_Op
        with Convention => C;
    ...
    type Physical_Device_Pipeline_Binary_Features is new Out_Structure
        (Physical_Device_Pipeline_Binary_Features_Type) with
    record
        Pipeline_Binaries: Boolean;
    end record;

    type Physical_Device_Pipeline_Binary_Properties is new Out_Structure
        (Physical_Device_Pipeline_Binary_Properties_Type) with
    record
        Pipeline_Binary_Internal_Cache: Boolean;
        Pipeline_Binary_Internal_Cache_Control: Boolean;
        Pipeline_Binary_Prefers_Internal_Cache: Boolean;
        Pipeline_Binary_Precompiled_Internal_Cache: Boolean;
        Pipeline_Binary_Compressed_Data: Boolean;
    end record;

    type Device_Pipeline_Binary_Internal_Cache_Control is new In_Structure
        (Device_Pipeline_Binary_Internal_Cache_Control_Type) with
    record
        Disable_Internal_Cache: Boolean;
    end record;

    type Pipeline_Binary_Key_Array is
        array (1 .. Max_Pipeline_Binary_Key_Size) of Interfaces.Unsigned_8
        with Convention => C;

    type Pipeline_Binary_Key is new Out_Structure(Pipeline_Binary_Key_Type) with
    record
        Key_Size: Interfaces.Unsigned_32;
        Key: Pipeline_Binary_Key_Array;
    end record;

    package Pipeline_Binary_Key_Vectors is new Ada.Containers.Vectors
        (Positive, Pipeline_Binary_Key);

    type Pipeline_Binary_Data is
    record
    ...
    package Pipeline_Binary_Data_Vectors is new Ada.Containers.Vectors
        (Positive, Pipeline_Binary_Data);

    type Pipeline_Binary_Keys_And_Data is
    record
        Pipeline_Binary_Keys: Pipeline_Binary_Key_Vectors.Vector;
        Pipeline_Binary_Data: Pipeline_Binary_Data_Vectors.Vector;
    end record;

    type Pipeline_Binary_Keys_And_Data_Access is
        access constant Pipeline_Binary_Keys_And_Data
        with Storage_Size => 0;

    type Pipeline_Create_Info is new In_Structure
        (Pipeline_Create_Info_Type) with null record;

    type Pipeline_Create_Info_Access is access constant Pipeline_Create_Info
        with Storage_Size => 0;

    type Pipeline_Binary_Create_Info is new In_Structure
        (Pipeline_Binary_Create_Info_Type) with
    record
        Keys_And_Data_Info: Pipeline_Binary_Keys_And_Data_Access;
        Pipeline: Vulkan.Pipeline;
        Pipeline_Create_Info: Pipeline_Create_Info_Access;
    end record;

    type Pipeline_Binary_Info is new In_Structure
        (Pipeline_Binary_Info_Type) with
    record
        Pipeline_Binaries: Pipeline_Binary_Vectors.Vector;
    end record;

    type Release_Captured_Pipeline_Data_Info is new Out_Structure
        (Release_Captured_Pipeline_Data_Info_Type) with
    record
        Pipeline: Vulkan.Pipeline;
    end record;

    type Pipeline_Binary_Data_Info is new Out_Structure
        (Pipeline_Binary_Data_Info_Type) with
    record
        Pipeline_Binary: KHR.Pipeline_Binary;
    end record;

    type Pipeline_Binary_Handles_Info is new In_Structure
        (Pipeline_Binary_Handles_Info_Type) with
    record
        Pipeline_Binaries: Pipeline_Binary_Vectors.Vector;
    end record;
    ...
    type Physical_Device_Compute_Shader_Derivatives_Features is
        new Out_Structure
            (Physical_Device_Compute_Shader_Derivatives_Features_Type) with
    record
        Compute_Derivative_Group_Quads: Boolean;
        Compute_Derivative_Group_Linear: Boolean;
    end record;

    type Physical_Device_Compute_Shader_Derivatives_Properties is
        new Out_Structure
            (Physical_Device_Compute_Shader_Derivatives_Properties_Type) with
    record
        Mesh_And_Task_Shader_Derivatives: Boolean;
    end record;
    ...
    type Physical_Device_Video_Encode_AV1_Features is new Out_Structure
        (Physical_Device_Video_Encode_AV1_Features_Type) with
    record
        Video_Encode_AV1: Boolean;
    end record;

    type Video_Encode_AV1_Capabilities is new Out_Structure
        (Video_Encode_AV1_Capabilities_Type) with
    record
        ...
        Std_Syntax_Flags: Video_Encode_AV1_Std_Flags :=
            Video_Encode_AV1_Std_No_Bit;
    end record;

    type Video_Encode_AV1_Q_Index is
    record
        Intra_Q_Index: Interfaces.Unsigned_32;
        Predictive_Q_Index: Interfaces.Unsigned_32;
        Bipredictive_Q_Index: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Video_Encode_AV1_Quality_Level_Properties is new Out_Structure
        (Video_Encode_AV1_Quality_Level_Properties_Type) with
    record
        ...
        Preferred_Temporal_Layer_Count: Interfaces.Unsigned_32;
        Preferred_Constant_Q_Index: Video_Encode_AV1_Q_Index;
    ...
    type Video_Encode_AV1_Session_Create_Info is new In_Structure
        (Video_Encode_AV1_Session_Create_Info_Type) with
    record
        Use_Max_Level: Boolean;
        Max_Level: Std_Video.AV1.Level;
    end record;

    type Video_Encode_AV1_Session_Parameters_Create_Info is new In_Structure
        (Video_Encode_AV1_Session_Parameters_Create_Info_Type) with
    record
        Std_Sequence_Header: Std_Video.AV1.Sequence_Header_Access;
        Std_Decoder_Model_Info: Std_Video.AV1.Encode.Decoder_Model_Info_Access;
        Std_Operating_Points:
            Std_Video.AV1.Encode.Operating_Point_Info_Vectors.Vector;
    end record;

    type Video_Encode_AV1_Picture_Info is new In_Structure
        (Video_Encode_AV1_Picture_Info_Type) with
    record
        ...
        Std_Picture_Info: Std_Video.AV1.Encode.Picture_Info_Access;
        Reference_Name_Slot_Indices: References_Per_Frame_Array;
        Primary_Reference_CDF_Only: Boolean;
        Generate_OBU_Extension_Header: Boolean;
    end record;

    type Video_Encode_AV1_DPB_Slot_Info is new In_Structure
        (Video_Encode_AV1_DPB_Slot_Info_Type) with
    record
        Std_Reference_Info: Std_Video.AV1.Encode.Reference_Info_Access;
    end record;

    type Video_Encode_AV1_Profile_Info is new In_Structure
        (Video_Encode_AV1_Profile_Info_Type) with
    record
        Std_Profile: Std_Video.AV1.Profile;
    end record;

    type Video_Encode_AV1_Frame_Size is
    record
        Intra_Frame_Size: Interfaces.Unsigned_32;
        Predictive_Frame_Size: Interfaces.Unsigned_32;
        Bipredictive_Frame_Size: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Video_Encode_AV1_GOP_Remaining_Frame_Info is new In_Structure
        (Video_Encode_AV1_GOP_Remaining_Frame_Info_Type) with
    record
        Use_GOP_Remaining_Frames: Boolean;
    ...
    type Video_Encode_AV1_Rate_Control_Info is new In_Structure
        (Video_Encode_AV1_Rate_Control_Info_Type) with
    record
    ...
    type Video_Encode_AV1_Rate_Control_Layer_Info is new In_Structure
        (Video_Encode_AV1_Rate_Control_Layer_Info_Type) with
    record
        Use_Min_Q_Index: Boolean;
        Min_Q_Index: Video_Encode_AV1_Q_Index;
        Use_Max_Q_Index: Boolean;
        Max_Q_Index: Video_Encode_AV1_Q_Index;
        Use_Max_Frame_Size: Boolean;
    ...
    type Video_Encode_Quantization_Map_Capabilities is new Out_Structure
        (Video_Encode_Quantization_Map_Capabilities_Type) with
    record
        Max_Quantization_Map_Extent: Extent_2D;
    end record;

    type Video_Format_Quantization_Map_Properties is new Out_Structure
        (Video_Format_Quantization_Map_Properties_Type) with
    record
        Quantization_Map_Texel_Size: Extent_2D;
    end record;

    type Video_Encode_Quantization_Map_Info is new In_Structure
        (Video_Encode_Quantization_Map_Info_Type) with
    record
        Quantization_Map: Image_View;
        Quantization_Map_Extent: Extent_2D;
    end record;

    type Video_Encode_Quantization_Map_Session_Parameters_Create_Info is
        new In_Structure
    ...
    type Physical_Device_Video_Encode_Quantization_Map_Features is
        new Out_Structure
            (Physical_Device_Video_Encode_Quantization_Map_Features_Type) with
    record
        Video_Encode_Quantization_Map: Boolean;
    end record;

    type Video_Encode_H264_Quantization_Map_Capabilities is new Out_Structure
        (Video_Encode_H264_Quantization_Map_Capabilities_Type) with
    record
        Min_QP_Delta: Interfaces.Integer_32;
        Max_QP_Delta: Interfaces.Integer_32;
    end record;

    type Video_Encode_H265_Quantization_Map_Capabilities is new Out_Structure
        (Video_Encode_H265_Quantization_Map_Capabilities_Type) with
    record
        Min_QP_Delta: Interfaces.Integer_32;
        Max_QP_Delta: Interfaces.Integer_32;
    end record;

    type Video_Format_H265_Quantization_Map_Properties is new Out_Structure
        (Video_Format_H265_Quantization_Map_Properties_Type) with
    record
        Compatible_CTB_Sizes: Video_Encode_H265_CTB_Size_Flags :=
            Video_Encode_H265_CTB_Size_No_Bit;
    end record;

    type Video_Encode_AV1_Quantization_Map_Capabilities is new Out_Structure
        (Video_Encode_AV1_Quantization_Map_Capabilities_Type) with
    record
        Min_Q_Index_Delta: Interfaces.Integer_32;
        Max_Q_Index_Delta: Interfaces.Integer_32;
    end record;

    type Video_Format_AV1_Quantization_Map_Properties is new Out_Structure
        (Video_Format_AV1_Quantization_Map_Properties_Type) with
    record
        Compatible_Superblock_Sizes: Video_Encode_AV1_Superblock_Size_Flags :=
            Video_Encode_AV1_Superblock_Size_No_Bit;
    end record;

    type Physical_Device_Shader_Relaxed_Extended_Instruction_Features is
        new Out_Structure
        (Physical_Device_Shader_Relaxed_Extended_Instruction_Features_Type) with
    record
        Shader_Relaxed_Extended_Instruction: Boolean;
    end record;

    type Physical_Device_Maintenance_7_Features is new Out_Structure
        (Physical_Device_Maintenance_7_Features_Type) with
    record
        Maintenance_7: Boolean;
    end record;

    type Physical_Device_Maintenance_7_Properties is new Out_Structure
        (Physical_Device_Maintenance_7_Properties_Type) with
    record
        Robust_Fragment_Shading_Rate_Attachment_Access: Boolean;
        Separate_Depth_Stencil_Attachment_Access: Boolean;
    ...
    type Physical_Device_Layered_API_Properties is new Out_Structure
        (Physical_Device_Layered_API_Properties_Type) with
    record
    ...
    package Physical_Device_Layered_API_Properties_Vectors is
        new Ada.Containers.Vectors
            (Positive, Physical_Device_Layered_API_Properties);

    -- If passed with Layered_API_Count set to 0, will return with the
    -- number of layered APIs.
    type Physical_Device_Layered_API_Properties_List is new Out_Structure
        (Physical_Device_Layered_API_Properties_List_Type) with
    record
        Layered_API_Count: Interfaces.Unsigned_32;
        Layered_APIs: Physical_Device_Layered_API_Properties_Vectors.Vector;
    end record;

    type Physical_Device_Layered_API_Vulkan_Properties is new Out_Structure
        (Physical_Device_Layered_API_Vulkan_Properties_Type) with
    record
        Properties: Physical_Device_Properties_2;
    end record;

    type Physical_Device_Maintenance_8_Features is new Out_Structure
        (Physical_Device_Maintenance_8_Features_Type) with
    record
        Maintenance_8: Boolean;
    end record;

    type Memory_Barrier_Access_Flags_3 is new In_Structure
        (Memory_Barrier_Access_Flags_3_Type) with
    record
        Src_Access_Mask_3: Access_Flags_3 := Access_Flags_3_None_Bit;
        Dst_Access_Mask_3: Access_Flags_3 := Access_Flags_3_None_Bit;
    end record;

    type Physical_Device_Video_Maintenance_2_Features is new Out_Structure
        (Physical_Device_Video_Maintenance_2_Features_Type) with
    record
        Video_Maintenance_2: Boolean;
    end record;

    type Video_Decode_H264_Inline_Session_Parameters_Info is new In_Structure
        (Video_Decode_H264_Inline_Session_Parameters_Info_Type) with
    record
        Std_SPS: Std_Video.H264.Sequence_Parameter_Set_Access;
        Std_PPS: Std_Video.H264.Picture_Parameter_Set_Access;
    end record;

    type Video_Decode_H265_Inline_Session_Parameters_Info is new In_Structure
        (Video_Decode_H265_Inline_Session_Parameters_Info_Type) with
    record
        Std_VPS: Std_Video.H265.Video_Parameter_Set_Access;
        Std_SPS: Std_Video.H265.Sequence_Parameter_Set_Access;
        Std_PPS: Std_Video.H265.Picture_Parameter_Set_Access;
    end record;

    type Video_Decode_AV1_Inline_Session_Parameters_Info is new In_Structure
        (Video_Decode_AV1_Inline_Session_Parameters_Info_Type) with
    record
        Std_Sequence_Header: Std_Video.AV1.Sequence_Header_Access;
    end record;

    type Physical_Device_Depth_Clamp_Zero_One_Features is new Out_Structure
        (Physical_Device_Depth_Clamp_Zero_One_Features_Type) with
    record
        Depth_Clamp_Zero_One: Boolean;
    end record;

    type Transform_Matrix_Array is
        array (1 .. 3, 1 .. 4) of Interfaces.C.C_float
        with Convention => C;

    type Transform_Matrix is
    record
        Matrix: Transform_Matrix_Array;
    end record
        with Convention => C;

    type Custom_Index is
    record
        Index: Packed_Bit := 0;
        Mask: Packed_Bit := 0;
    end record
    ...
    for Custom_Index use
    record
        Index at 0 range 0 .. 23;
        Mask at 0 range 24 .. 31;
    end record;

    type Table_Record_Offset is
    record
        Offset: Packed_Bit := 0;
        -- This should be KHR.Geometry_Instance_Flags, but Ada rules
        -- won't allow the size to be shrunk to 8 bits.  If you need
        -- to use these flags, some typecasting will be necessary.
        Flags: Packed_Bit := 0;
    end record
        with Convention => C;

    for Table_Record_Offset use
    record
        Offset at 0 range 0 .. 23;
        Flags at 0 range 24 .. 31;
    end record;

    type Acceleration_Structure_Instance is
    record
        Transform: Transform_Matrix;
        Instance_Custom_Index: Custom_Index;
        Instance_Shader_Binding_Table_Record_Offset: Table_Record_Offset;
        Acceleration_Structure_Reference: Interfaces.Unsigned_64;
    end record
        with Convention => C;

    type Device_Or_Host_Address(Add_Type: Address_Type) is
    record
        case Add_Type is
            when Device =>
    ...
    type Xlib_Surface_Create_Info is new In_Structure
        (Xlib_Surface_Create_Info_Type) with
    record
    ...
    type Xcb_Surface_Create_Info is new In_Structure
        (Xcb_Surface_Create_Info_Type) with
    record
    ...
    type Wayland_Surface_Create_Info is new In_Structure
        (Wayland_Surface_Create_Info_Type) with
    record
    ...
    type Android_Surface_Create_Info is new In_Structure
        (Android_Surface_Create_Info_Type) with
    record
        Flags: Android_Surface_Create_Flags := Android_Surface_Create_No_Bit;
        Window: Android.Native_Window;
    end record;

    type Win32_Surface_Create_Info is new In_Structure
        (Win32_Surface_Create_Info_Type) with
    record
