...
package body Vulkan.Extensions.KHR_Xlib_Surface is
    -- Loaded extension functions.
    type vkCreateXlibSurfaceKHR_Access is
        access function
            (Instance: in Vulkan.Instance;
             Create_Info: in C_KHR.Xlib_Surface_Create_Info_C;
    ...
    package Surfaces_Common is
        new Platform_Surfaces(KHR.Xlib_Surface_Create_Info,
                              C_KHR.Xlib_Surface_Create_Info_C,
                              C_KHR.To_C,
                              C_KHR.Free,
    ...
    function Create(Instance: in Vulkan.Instance;
                    Create_Info: in KHR.Xlib_Surface_Create_Info;
...
end Vulkan.Extensions.KHR_Xlib_Surface;
