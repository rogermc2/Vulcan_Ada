...
private package Vulkan.C is
    ...
    type Clear_Value_C(Clear_Type: Clear_Value_Type := Clear_Color;
                       Color_Type: Clear_Color_Type := Clear_Color_Float) is
    record
        case Clear_Type is
            when Clear_Color =>
    ...
    type Clear_Attachment_C
        (Clear_Type: Clear_Value_Type := Clear_Color;
         Color_Type: Clear_Color_Type := Clear_Color_Float) is
    record
    ...
    procedure vkCmdCopyQueryPoolResults
        (Command_Buffer: in Vulkan.Command_Buffer;
         ...
         Dst_Buffer: in Buffer;
         Dst_Offset, Stride: in Device_Size;
