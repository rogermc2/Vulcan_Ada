...
package Vulkan.Extensions.KHR_External_Memory_FD is
    ...
    function Get_Memory_FD_Properties
        (Device: in Vulkan.Device;
         ...
         Memory_FD_Properties: out KHR.Memory_FD_Properties) return Result
        with Pre => Device /= No_Device and
    ...
    function Get_Memory_FD_Properties
        (Device: in Vulkan.Device;
         Handle_Type: in External_Memory_Handle_Type_Flags;
         FD: in File_Descriptor) return KHR.Memory_FD_Properties
        with Pre => Device /= No_Device and
                    Handle_Type /= External_Memory_Handle_Type_Opaque_FD_Bit;
