...
package Vulkan.Extensions.EXT_Debug_Utils is
    use type EXT.Debug_Utils_Messenger;
    use type EXT.Debug_Utils_Message_Severity_Flags;
    use type EXT.Debug_Utils_Message_Type_Flags;
    use type EXT.Debug_Messenger_Callback;
    ...
    procedure Queue_Begin_Label(Queue: in Vulkan.Queue;
                                Label_Info: in EXT.Debug_Utils_Label)
    ...
    function Create(Instance: in Vulkan.Instance;
        ...
        with Pre => Instance /= No_Instance and
                    ...
                    EXT.Debug_Utils_Message_Severity_No_Bit and
                    Create_Info.Message_Type /=
                    EXT.Debug_Utils_Message_Type_No_Bit and
    ...
    function Create(Instance: in Vulkan.Instance;
                    Create_Info: in EXT.Debug_Utils_Messenger_Create_Info;
                    Allocator: aliased in Allocation_Callbacks)
        return EXT.Debug_Utils_Messenger
        with Pre => Instance /= No_Instance and
                    Create_Info.Message_Severity /=
                    EXT.Debug_Utils_Message_Severity_No_Bit and
                    Create_Info.Message_Type /=
                    EXT.Debug_Utils_Message_Type_No_Bit and
                    Create_Info.User_Callback /= null,
             Post => Create'Result /= EXT.No_Debug_Utils_Messenger;
    ...
    procedure Destroy(Instance: in Vulkan.Instance;
                      ...
                      Allocator: aliased in Allocation_Callbacks)
        with Pre => Instance /= No_Instance,
             Post => Messenger = EXT.No_Debug_Utils_Messenger;
    ...
    procedure Submit_Message
        (Instance: in Vulkan.Instance;
         ...
         Callback_Data: in EXT.Debug_Utils_Messenger_Callback_Data)
        with Pre => Instance /= No_Instance and
                    Message_Types /= EXT.Debug_Utils_Message_Type_No_Bit and
