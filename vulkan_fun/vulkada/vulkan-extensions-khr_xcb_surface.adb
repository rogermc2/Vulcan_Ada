...
package body Vulkan.Extensions.KHR_Xcb_Surface is
    -- Loaded extension functions.
    type vkCreateXcbSurfaceKHR_Access is
        access function
            (Instance: in Vulkan.Instance;
             Create_Info: in C_KHR.Xcb_Surface_Create_Info_C;
    ...
    package Surfaces_Common is
        new Platform_Surfaces(KHR.Xcb_Surface_Create_Info,
                              C_KHR.Xcb_Surface_Create_Info_C,
                              C_KHR.To_C,
                              C_KHR.Free,
