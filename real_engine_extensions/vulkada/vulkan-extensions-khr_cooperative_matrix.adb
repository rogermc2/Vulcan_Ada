...
package body Vulkan.Extensions.KHR_Cooperative_Matrix is
    ...
    type vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR_Access is
        access function
            (Physical_Device: in Vulkan.Physical_Device;
             ...
             Properties: access C_KHR.Cooperative_Matrix_Properties_C)
        return Result
        with Convention => C;
    ...
    function Get_Physical_Device_Cooperative_Matrix_Properties
        (Physical_Device: in Vulkan.Physical_Device;
         Properties: in out KHR.Cooperative_Matrix_Properties_Vectors.Vector)
        return Result is
    begin
        ...
        declare
            ...
            C_Properties: array (1 .. Positive(Count)) of aliased
                C_KHR.Cooperative_Matrix_Properties_C
                with Convention => C;
    ...
    function Get_Physical_Device_Cooperative_Matrix_Properties
        (Physical_Device: in Vulkan.Physical_Device)
        return KHR.Cooperative_Matrix_Properties_Vectors.Vector is
        Properties: KHR.Cooperative_Matrix_Properties_Vectors.Vector;
        Property: KHR.Cooperative_Matrix_Properties;
    begin
        Properties.Append
...
end Vulkan.Extensions.KHR_Cooperative_Matrix;
