...
package body Vulkan.Extensions.KHR_Pipeline_Executable_Properties is
    ...
    type vkGetPipelineExecutablePropertiesKHR_Access is
        access function
            (Device: in Vulkan.Device;
             ...
             Properties: access C_KHR.Pipeline_Executable_Properties_C)
        return Result
        with Convention => C;
    ...
    type vkGetPipelineExecutableStatisticsKHR_Access is
        access function
            (Device: in Vulkan.Device;
             Executable_Info: in C_KHR.Pipeline_Executable_Info_C;
             Statistic_Count: in out Interfaces.Unsigned_32;
             Statistics: access C_KHR.Pipeline_Executable_Statistic_C)
        return Result
        with Convention => C;
        ...
        access function
            (Device: in Vulkan.Device;
             ...
             Internal_Representations:
                access C_KHR.Pipeline_Executable_Internal_Representation_C)
        return Result
        with Convention => C;
    ...
    begin
        ...
        declare
            ...
            C_Properties: array (1 .. Positive(Count)) of aliased
                C_KHR.Pipeline_Executable_Properties_C;
    ...
    function Get_Properties(Device: in Vulkan.Device;
                            Pipeline_Info: in KHR.Pipeline_Info)
        return KHR.Pipeline_Executable_Properties_Vectors.Vector is
        Properties: KHR.Pipeline_Executable_Properties_Vectors.Vector;
        Property: KHR.Pipeline_Executable_Properties;
    begin
    ...
    function Statistics_Count(Device: in Vulkan.Device;
        ...
        return Interfaces.Unsigned_32 is
        C_Info: C_KHR.Pipeline_Executable_Info_C := C_KHR.To_C(Executable_Info);
        Count: Interfaces.Unsigned_32 := 0;
    begin
    ...
    begin
        ...
        declare
            C_Info: C_KHR.Pipeline_Executable_Info_C :=
                        C_KHR.To_C(Executable_Info);
            C_Statistics: array (1 .. Positive(Count)) of aliased
                C_KHR.Pipeline_Executable_Statistic_C(Extensions.KHR.Bool32);
            Result: Vulkan.Result;
        begin
            ...
            if Result in Success | Incomplete then
                ...
                for CS of C_Statistics loop
                    declare
                        Stat: KHR.Pipeline_Executable_Statistic(CS.Format);
                    begin
                        C_KHR.To_Ada(Stat, CS);
    ...
    function Get_Statistics(Device: in Vulkan.Device;
                            Executable_Info: in KHR.Pipeline_Executable_Info)
        return KHR.Pipeline_Executable_Statistic_Vectors.Vector is
        Statistics: KHR.Pipeline_Executable_Statistic_Vectors.Vector;
    begin
    ...
    begin
        ...
        declare
            ...
            C_Representations: array (1 .. Positive(Count)) of aliased
                C_KHR.Pipeline_Executable_Internal_Representation_C;
            Result: Vulkan.Result;
        begin
            ...
            if Result in Success | Incomplete then
                for X in C_Representations'Range loop
                    C_KHR.To_Ada(Internal_Representations(X),
                                 C_Representations(X));
    ...
    function Get_Internal_Representations
        (Device: in Vulkan.Device;
         Executable_Info: in KHR.Pipeline_Executable_Info)
        return KHR.Pipeline_Executable_Internal_Representation_Vectors.Vector is
        Representations:
            KHR.Pipeline_Executable_Internal_Representation_Vectors.Vector;
        Representation: KHR.Pipeline_Executable_Internal_Representation;
    begin
