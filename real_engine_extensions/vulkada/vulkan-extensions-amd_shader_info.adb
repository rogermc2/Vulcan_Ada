...
package body Vulkan.Extensions.AMD_Shader_Info is
    ...
    type vkGetShaderInfoAMD_Access is
        access function(Device: in Vulkan.Device;
                        ...
                        Info_Type: in AMD.Shader_Info_Type;
    ...
    function Get_Statistics(Device: in Vulkan.Device;
                            Pipeline: in Vulkan.Pipeline;
                            Shader_Stage: in Shader_Stage_Flags;
                            Statistics: out AMD.Shader_Statistics_Info)
        return Result is
    ...
    function Get_Statistics(Device: in Vulkan.Device;
                            Pipeline: in Vulkan.Pipeline;
                            Shader_Stage: in Shader_Stage_Flags)
        return AMD.Shader_Statistics_Info is
        Statistics: AMD.Shader_Statistics_Info;
    begin
...
end Vulkan.Extensions.AMD_Shader_Info;
