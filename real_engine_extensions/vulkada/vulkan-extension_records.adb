...
package body Vulkan.Extension_Records is
    ...
    begin
        ...
        case Next.Record_Type is
            ...
            when C_V1_4.In_Structure =>
                return C_V1_4.To_C(Next);
            ...
            when C_INTEL.In_Structure =>
                return C_INTEL.To_C(Next);
            when C_QCOM.In_Structure =>
                return C_QCOM.To_C(Next);
            when C_HUAWEI.In_Structure =>
                return C_HUAWEI.To_C(Next);
        end case;
    end To_C;
    ...
    begin
        ...
        case Next.Record_Type is
            ...
            when C_IMG.Out_Structure =>
                return C_IMG.To_C(Next);
            when C_INTEL.Out_Structure =>
                return C_INTEL.To_C(Next);
            when C_QCOM.Out_Structure =>
                return C_QCOM.To_C(Next);
            when C_HUAWEI.Out_Structure =>
                return C_HUAWEI.To_C(Next);
        end case;
    end To_C;

    procedure To_Ada(Ada_Struct: in Out_Structure_Access;
    ...
    begin
        ...
        case Ada_Struct.Record_Type is
            ...
            when C_V1_4.Out_Structure =>
                C_V1_4.To_Ada(Ada_Struct.all, Next);
            when C_KHR.Out_Structure =>
            ...
            when C_INTEL.Out_Structure =>
                C_INTEL.To_Ada(Ada_Struct.all, Next);
            when C_QCOM.Out_Structure =>
                C_QCOM.To_Ada(Ada_Struct.all, Next);
            when C_HUAWEI.Out_Structure =>
                C_HUAWEI.To_Ada(Ada_Struct.all, Next);
        end case;
    end To_Ada;
