...
private generic
    ...
    with function "<" (Left, Right: in Object_Type) return Boolean is <>;
package Vulkan.Callback_Marshallers is
    ...
    package Marshaller_Access_Vectors is new Ada.Containers.Vectors
        (Positive, Marshaller_Access);
    package Marshaller_Maps is new Ada.Containers.Ordered_Maps
        (Object_Type,
         Marshaller_Access_Vectors.Vector,
         "=" => Marshaller_Access_Vectors."=");
