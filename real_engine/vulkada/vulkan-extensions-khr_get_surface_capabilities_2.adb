...
package body Vulkan.Extensions.KHR_Get_Surface_Capabilities_2 is
    -- Loaded extension functions.
    type vkGetPhysicalDeviceSurfaceCapabilities2KHR_Access is
        access function
            (Physical_Device: in Vulkan.Physical_Device;
             Surface_Info: in C_KHR.Physical_Device_Surface_Info_2_C;
             Surface_Capabilities: out C_KHR.Surface_Capabilities_2_C)
        return Result
        with Convention => C;
    ...
    type vkGetPhysicalDeviceSurfaceFormats2KHR_Access is
        access function
            (Physical_Device: in Vulkan.Physical_Device;
             ...
             Surface_Formats: access C_KHR.Surface_Format_2_C)
        return Result
        with Convention => C;
    ...
    function Get_Surface_Capabilities
        (Physical_Device: in Vulkan.Physical_Device;
         ...
         Surface_Capabilities: in out KHR.Surface_Capabilities_2)
        return Result is
        Surface_Info_C: C_KHR.Physical_Device_Surface_Info_2_C :=
            C_KHR.To_C(Surface_Info);
        Surface_Capabilities_C: C_KHR.Surface_Capabilities_2_C;
    ...
    begin
        ...
        C_KHR.Free(Surface_Info_C);
        C_KHR.To_Ada(Surface_Capabilities, Surface_Capabilities_C);
    ...
    function Get_Surface_Capabilities
        (Physical_Device: in Vulkan.Physical_Device;
         Surface_Info: in KHR.Physical_Device_Surface_Info_2)
        return KHR.Surface_Capabilities_2 is
        Capabilities: KHR.Surface_Capabilities_2;
    begin
    ...
    function Get_Surface_Formats
        ...
        Surface_Formats_C: array (1 .. Positive(Surface_Formats.Length)) of
            aliased C_KHR.Surface_Format_2_C;
    ...
    begin
        ...
        for X in Surface_Formats_C'Range loop
            C_KHR.To_Ada(Surface_Formats(X), Surface_Formats_C(X));
    ...
    function Get_Surface_Formats
        (Physical_Device: in Vulkan.Physical_Device;
         Surface_Info: in KHR.Physical_Device_Surface_Info_2)
        return KHR.Surface_Format_2_Vectors.Vector is
        Format: KHR.Surface_Format_2;
        Count: Ada.Containers.Count_Type :=
            Ada.Containers.Count_Type(Surface_Format_Count(Physical_Device,
                                                           Surface_Info));
        Formats: KHR.Surface_Format_2_Vectors.Vector :=
            KHR.Surface_Format_2_Vectors.To_Vector(Format, Count);
    begin
