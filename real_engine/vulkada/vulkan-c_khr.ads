...
with Vulkan.Extensions.Std_Video.AV1.Encode;
...
private package Vulkan.C_KHR is
    ...
    subtype Structure is Structure_Type
        with Static_Predicate => Structure in
            ...
            Physical_Device_Pipeline_Binary_Features_Type |
            Physical_Device_Pipeline_Binary_Properties_Type |
            Device_Pipeline_Binary_Internal_Cache_Control_Type |
            Pipeline_Binary_Key_Type |
            Pipeline_Create_Info_Type |
            Pipeline_Binary_Create_Info_Type |
            Pipeline_Binary_Info_Type |
            Release_Captured_Pipeline_Data_Info_Type |
            Pipeline_Binary_Data_Info_Type |
            Pipeline_Binary_Handles_Info_Type |
            ...
            Physical_Device_Compute_Shader_Derivatives_Features_Type |
            Physical_Device_Compute_Shader_Derivatives_Properties_Type |
            ...
            Physical_Device_Video_Encode_AV1_Features_Type |
            Video_Encode_AV1_Capabilities_Type |
            Video_Encode_AV1_Quality_Level_Properties_Type |
            Video_Encode_AV1_Session_Create_Info_Type |
            Video_Encode_AV1_Session_Parameters_Create_Info_Type |
            Video_Encode_AV1_Picture_Info_Type |
            Video_Encode_AV1_DPB_Slot_Info_Type |
            Video_Encode_AV1_Profile_Info_Type |
            Video_Encode_AV1_GOP_Remaining_Frame_Info_Type |
            Video_Encode_AV1_Rate_Control_Info_Type |
            Video_Encode_AV1_Rate_Control_Layer_Info_Type |
            Physical_Device_Video_Maintenance_1_Features_Type |
            Video_Inline_Query_Info_Type |
            Calibrated_Timestamp_Info_Type |
            Video_Encode_Quantization_Map_Capabilities_Type |
            Video_Format_Quantization_Map_Properties_Type |
            Video_Encode_Quantization_Map_Info_Type |
            Video_Encode_Quantization_Map_Session_Parameters_Create_Info_Type |
            Physical_Device_Video_Encode_Quantization_Map_Features_Type |
            Video_Encode_H264_Quantization_Map_Capabilities_Type |
            Video_Encode_H265_Quantization_Map_Capabilities_Type |
            Video_Format_H265_Quantization_Map_Properties_Type |
            Video_Encode_AV1_Quantization_Map_Capabilities_Type |
            Video_Format_AV1_Quantization_Map_Properties_Type |
            Physical_Device_Shader_Relaxed_Extended_Instruction_Features_Type |
            Physical_Device_Maintenance_7_Features_Type |
            Physical_Device_Maintenance_7_Properties_Type |
            Physical_Device_Layered_API_Properties_Type |
            Physical_Device_Layered_API_Properties_List_Type |
            Physical_Device_Layered_API_Vulkan_Properties_Type |
            Physical_Device_Maintenance_8_Features_Type |
            Memory_Barrier_Access_Flags_3_Type |
            Physical_Device_Video_Maintenance_2_Features_Type |
            Video_Decode_H264_Inline_Session_Parameters_Info_Type |
            Video_Decode_H265_Inline_Session_Parameters_Info_Type |
            Video_Decode_AV1_Inline_Session_Parameters_Info_Type |
            Physical_Device_Depth_Clamp_Zero_One_Features_Type |
            Xlib_Surface_Create_Info_Type |
            Xcb_Surface_Create_Info_Type |
            Wayland_Surface_Create_Info_Type |
            Android_Surface_Create_Info_Type |
    ...
    type Pipeline_Executable_Statistic_C
        (Format_Type: Extensions.KHR.Pipeline_Executable_Statistic_Format :=
            Extensions.KHR.Bool32) is
    record
    ...
    record
        ...
        Next: C.In_Structure_C_Access;
        Swapchain_Count: Interfaces.Unsigned_32;
        Present_IDs: C.Uint64_t_Arrays.Pointer;
    end record
        with Convention => C;
    ...
    type Physical_Device_Pipeline_Binary_Features_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Pipeline_Binary_Features_Type;
        Next: C.Out_Structure_C_Access;
        Pipeline_Binaries: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Pipeline_Binary_Features_C_Access is
        access Physical_Device_Pipeline_Binary_Features_C
        with Convention => C;

    type Physical_Device_Pipeline_Binary_Properties_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Pipeline_Binary_Properties_Type;
        Next: C.Out_Structure_C_Access;
        Pipeline_Binary_Internal_Cache: Interfaces.Unsigned_32;
        Pipeline_Binary_Internal_Cache_Control: Interfaces.Unsigned_32;
        Pipeline_Binary_Prefers_Internal_Cache: Interfaces.Unsigned_32;
        Pipeline_Binary_Precompiled_Internal_Cache: Interfaces.Unsigned_32;
        Pipeline_Binary_Compressed_Data: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Pipeline_Binary_Properties_C_Access is
        access Physical_Device_Pipeline_Binary_Properties_C
        with Convention => C;

    type Device_Pipeline_Binary_Internal_Cache_Control_C is
    record
        Record_Type: In_Structure_Type :=
            Device_Pipeline_Binary_Internal_Cache_Control_Type;
        Next: C.In_Structure_C_Access;
        Disable_Internal_Cache: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Device_Pipeline_Binary_Internal_Cache_Control_C_Access is
        access Device_Pipeline_Binary_Internal_Cache_Control_C
        with Convention => C;

    type Pipeline_Binary_Key_C is
    record
        Record_Type: Out_Structure_Type := Pipeline_Binary_Key_Type;
        Next: C.Out_Structure_C_Access;
        Key_Size: Interfaces.Unsigned_32;
        Key: Extensions.KHR.Pipeline_Binary_Key_Array;
    end record
        with Convention => C;

    type Pipeline_Binary_Key_C_Access is access Pipeline_Binary_Key_C
        with Convention => C;

    package Pipeline_Binary_Key_C_Arrays is
        new Vulkan.C_Arrays(Pipeline_Binary_Key_C);

    package Pipeline_Binary_Data_Arrays is
        new Vulkan.C_Arrays(Extensions.KHR.Pipeline_Binary_Data);

    type Pipeline_Binary_Keys_And_Data_C is
    record
        Binary_Count: Interfaces.Unsigned_32;
        Pipeline_Binary_Keys: Pipeline_Binary_Key_C_Arrays.Pointer;
        Pipeline_Binary_Data: Pipeline_Binary_Data_Arrays.Pointer;
    end record
        with Convention => C;

    type Pipeline_Binary_Keys_And_Data_C_Access is
        access Pipeline_Binary_Keys_And_Data_C
        with Convention => C;

    type Pipeline_Create_Info_C is
    record
        Record_Type: In_Structure_Type := Pipeline_Create_Info_Type;
        Next: C.In_Structure_C_Access;
    end record
        with Convention => C;

    type Pipeline_Create_Info_C_Access is access Pipeline_Create_Info_C
        with Convention => C;

    type Pipeline_Binary_Create_Info_C is
    record
        Record_Type: In_Structure_Type := Pipeline_Binary_Create_Info_Type;
        Next: C.In_Structure_C_Access;
        Keys_And_Data_Info: Pipeline_Binary_Keys_And_Data_C_Access;
        Pipeline: Vulkan.Pipeline;
        Pipeline_Create_Info: Pipeline_Create_Info_C_Access;
    end record
        with Convention => C;

    type Pipeline_Binary_Create_Info_C_Access is
        access Pipeline_Binary_Create_Info_C
        with Convention => C;

    package Pipeline_Binary_Arrays is
        new C_Arrays(Extensions.KHR.Pipeline_Binary);

    type Pipeline_Binary_Info_C is
    record
        Record_Type: In_Structure_Type := Pipeline_Binary_Info_Type;
        Next: C.In_Structure_C_Access;
        Binary_Count: Interfaces.Unsigned_32;
        Pipeline_Binaries: Pipeline_Binary_Arrays.Pointer;
    end record
        with Convention => C;

    type Pipeline_Binary_Info_C_Access is access Pipeline_Binary_Info_C
        with Convention => C;

    type Release_Captured_Pipeline_Data_Info_C is
    record
        Record_Type: Out_Structure_Type :=
            Release_Captured_Pipeline_Data_Info_Type;
        Next: C.Out_Structure_C_Access;
    ...
    type Release_Captured_Pipeline_Data_Info_C_Access is
        access Release_Captured_Pipeline_Data_Info_C
        with Convention => C;

    type Pipeline_Binary_Data_Info_C is
    record
        Record_Type: Out_Structure_Type := Pipeline_Binary_Data_Info_Type;
        Next: C.Out_Structure_C_Access;
        Pipeline_Binary: Extensions.KHR.Pipeline_Binary;
    end record
        with Convention => C;

    type Pipeline_Binary_Data_Info_C_Access is
        access Pipeline_Binary_Data_Info_C
        with Convention => C;

    type Pipeline_Binary_Handles_Info_C is
    record
        Record_Type: In_Structure_Type := Pipeline_Binary_Handles_Info_Type;
        Next: C.In_Structure_C_Access;
        Pipeline_Binary_Count: Interfaces.Unsigned_32;
        Pipeline_Binaries: Pipeline_Binary_Arrays.Pointer;
    end record
        with Convention => C;

    type Pipeline_Binary_Handles_Info_C_Access is
        access Pipeline_Binary_Handles_Info_C
        with Convention => C;
    ...
    type Physical_Device_Compute_Shader_Derivatives_Features_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Compute_Shader_Derivatives_Features_Type;
        Next: C.Out_Structure_C_Access;
        Compute_Derivative_Group_Quads: Interfaces.Unsigned_32;
        Compute_Derivative_Group_Linear: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Compute_Shader_Derivatives_Features_C_Access is
        access Physical_Device_Compute_Shader_Derivatives_Features_C
        with Convention => C;

    type Physical_Device_Compute_Shader_Derivatives_Properties_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Compute_Shader_Derivatives_Properties_Type;
        Next: C.Out_Structure_C_Access;
        Mesh_And_Task_Shader_Derivatives: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Compute_Shader_Derivatives_Properties_C_Access is
        access Physical_Device_Compute_Shader_Derivatives_Properties_C
        with Convention => C;
    ...
    type Physical_Device_Video_Encode_AV1_Features_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Video_Encode_AV1_Features_Type;
        Next: C.Out_Structure_C_Access;
        Video_Encode_AV1: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Video_Encode_AV1_Features_C_Access is
        access Physical_Device_Video_Encode_AV1_Features_C
        with Convention => C;

    type Video_Encode_AV1_Capabilities_C is
    record
        Record_Type: Out_Structure_Type := Video_Encode_AV1_Capabilities_Type;
        Next: C.Out_Structure_C_Access;
        Flags: Extensions.KHR.Video_Encode_AV1_Capability_Flags;
        Max_Level: Extensions.Std_Video.AV1.Level;
        Coded_Picture_Alignment: Extent_2D;
        Max_Tiles: Extent_2D;
        Min_Tile_Size: Extent_2D;
        Max_Tile_Size: Extent_2D;
        Superblock_Sizes: Extensions.KHR.Video_Encode_AV1_Superblock_Size_Flags;
        Max_Single_Reference_Count: Interfaces.Unsigned_32;
        Single_Reference_Name_Mask: Interfaces.Unsigned_32;
        Max_Unidirectional_Compound_Reference_Count: Interfaces.Unsigned_32;
        Max_Unidirectional_Compound_Group_1_Reference_Count:
            Interfaces.Unsigned_32;
        Unidirectional_Compound_Reference_Name_Mask: Interfaces.Unsigned_32;
        Max_Bidirectional_Compound_Reference_Count: Interfaces.Unsigned_32;
        Max_Bidirectional_Compound_Group_1_Reference_Count:
            Interfaces.Unsigned_32;
        Max_Bidirectional_Compound_Group_2_Reference_Count:
            Interfaces.Unsigned_32;
        Bidirectional_Compound_Reference_Name_Mask: Interfaces.Unsigned_32;
        Max_Temporal_Layer_Count: Interfaces.Unsigned_32;
        Max_Spatial_Layer_Count: Interfaces.Unsigned_32;
        Max_Operating_Points: Interfaces.Unsigned_32;
        Min_Q_Index: Interfaces.Unsigned_32;
        Max_Q_Index: Interfaces.Unsigned_32;
        Prefers_GOP_Remaining_Frames: Interfaces.Unsigned_32;
        Requires_GOP_Remaining_Frames: Interfaces.Unsigned_32;
        Std_Syntax_Flags: Extensions.KHR.Video_Encode_AV1_Std_Flags;
    end record
        with Convention => C;

    type Video_Encode_AV1_Capabilities_C_Access is
        access Video_Encode_AV1_Capabilities_C
        with Convention => C;

    type Video_Encode_AV1_Quality_Level_Properties_C is
    record
        Record_Type: Out_Structure_Type :=
            Video_Encode_AV1_Quality_Level_Properties_Type;
        Next: C.Out_Structure_C_Access;
        Preferred_Rate_Control_Flags:
            Extensions.KHR.Video_Encode_AV1_Rate_Control_Flags;
        Preferred_GOP_Frame_Count: Interfaces.Unsigned_32;
        Preferred_Key_Frame_Period: Interfaces.Unsigned_32;
        Preferred_Consecutive_Bipredictive_Frame_Count: Interfaces.Unsigned_32;
        Preferred_Temporal_Layer_Count: Interfaces.Unsigned_32;
        Preferred_Constant_Q_Index: Extensions.KHR.Video_Encode_AV1_Q_Index;
        Preferred_Max_Single_Reference_Count: Interfaces.Unsigned_32;
        Preferred_Single_Reference_Name_Mask: Interfaces.Unsigned_32;
        Preferred_Max_Unidirectional_Compound_Reference_Count:
            Interfaces.Unsigned_32;
        Preferred_Max_Unidirectional_Compound_Group_1_Reference_Count:
            Interfaces.Unsigned_32;
        ...
        Preferred_Max_Bidirectional_Compound_Group_1_Reference_Count:
            Interfaces.Unsigned_32;
        Preferred_Max_Bidirectional_Compound_Group_2_Reference_Count:
            Interfaces.Unsigned_32;
    ...
    type Video_Encode_AV1_Quality_Level_Properties_C_Access is
        access Video_Encode_AV1_Quality_Level_Properties_C
        with Convention => C;

    type Video_Encode_AV1_Session_Create_Info_C is
    record
        Record_Type: In_Structure_Type :=
            Video_Encode_AV1_Session_Create_Info_Type;
        Next: C.In_Structure_C_Access;
        Use_Max_Level: Interfaces.Unsigned_32;
        Max_Level: Extensions.Std_Video.AV1.Level;
    end record
        with Convention => C;

    type Video_Encode_AV1_Session_Create_Info_C_Access is
        access Video_Encode_AV1_Session_Create_Info_C
        with Convention => C;

    package AV1_Encode_Operating_Point_Info_Arrays is
        new C_Arrays(Extensions.Std_Video.AV1.Encode.Operating_Point_Info);

    type Video_Encode_AV1_Session_Parameters_Create_Info_C is
    record
        Record_Type: In_Structure_Type :=
            Video_Encode_AV1_Session_Parameters_Create_Info_Type;
        Next: C.In_Structure_C_Access;
        Std_Sequence_Header: Extensions.Std_Video.AV1.Sequence_Header_Access;
        Std_Decoder_Model_Info:
            Extensions.Std_Video.AV1.Encode.Decoder_Model_Info_Access;
        Std_Operating_Point_Count: Interfaces.Unsigned_32;
        Std_Operating_Points: AV1_Encode_Operating_Point_Info_Arrays.Pointer;
    end record
        with Convention => C;

    type Video_Encode_AV1_Session_Parameters_Create_Info_C_Access is
        access Video_Encode_AV1_Session_Parameters_Create_Info_C
        with Convention => C;

    type Video_Encode_AV1_Picture_Info_C is
    record
        Record_Type: In_Structure_Type := Video_Encode_AV1_Picture_Info_Type;
        Next: C.In_Structure_C_Access;
        Prediction_Mode: Extensions.KHR.Video_Encode_AV1_Prediction_Mode;
        Rate_Control_Group: Extensions.KHR.Video_Encode_AV1_Rate_Control_Group;
        Constant_Q_Index: Interfaces.Unsigned_32;
        Std_Picture_Info: Extensions.Std_Video.AV1.Encode.Picture_Info_Access;
        Reference_Name_Slot_Indices: Extensions.KHR.References_Per_Frame_Array;
        Primary_Reference_CDF_Only: Interfaces.Unsigned_32;
        Generate_OBU_Extension_Header: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Video_Encode_AV1_Picture_Info_C_Access is
        access Video_Encode_AV1_Picture_Info_C
        with Convention => C;

    type Video_Encode_AV1_DPB_Slot_Info_C is
    record
        Record_Type: In_Structure_Type := Video_Encode_AV1_DPB_Slot_Info_Type;
        Next: C.In_Structure_C_Access;
        Std_Reference_Info:
            Extensions.Std_Video.AV1.Encode.Reference_Info_Access;
    end record
        with Convention => C;

    type Video_Encode_AV1_DPB_Slot_Info_C_Access is
        access Video_Encode_AV1_DPB_Slot_Info_C
        with Convention => C;

    type Video_Encode_AV1_Profile_Info_C is
    record
        Record_Type: In_Structure_Type := Video_Encode_AV1_Profile_Info_Type;
        Next: C.In_Structure_C_Access;
        Std_Profile: Extensions.Std_Video.AV1.Profile;
    end record
        with Convention => C;

    type Video_Encode_AV1_Profile_Info_C_Access is access
        Video_Encode_AV1_Profile_Info_C
        with Convention => C;

    type Video_Encode_AV1_GOP_Remaining_Frame_Info_C is
    record
        Record_Type: In_Structure_Type :=
            Video_Encode_AV1_GOP_Remaining_Frame_Info_Type;
        Next: C.In_Structure_C_Access;
        Use_GOP_Remaining_Frames: Interfaces.Unsigned_32;
        GOP_Remaining_Intra: Interfaces.Unsigned_32;
        GOP_Remaining_Predictive: Interfaces.Unsigned_32;
        GOP_Remaining_Bipredictive: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Video_Encode_AV1_GOP_Remaining_Frame_Info_C_Access is
        access Video_Encode_AV1_GOP_Remaining_Frame_Info_C
        with Convention => C;

    type Video_Encode_AV1_Rate_Control_Info_C is
    record
        Record_Type: In_Structure_Type :=
            Video_Encode_AV1_Rate_Control_Info_Type;
        Next: C.In_Structure_C_Access;
        Flags: Extensions.KHR.Video_Encode_AV1_Rate_Control_Flags;
        GOP_Frame_Count: Interfaces.Unsigned_32;
        Key_Frame_Period: Interfaces.Unsigned_32;
        Consecutive_Bipredictive_Frame_Count: Interfaces.Unsigned_32;
        Temporal_Layer_Count: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Video_Encode_AV1_Rate_Control_Info_C_Access is
        access Video_Encode_AV1_Rate_Control_Info_C
        with Convention => C;

    type Video_Encode_AV1_Rate_Control_Layer_Info_C is
    record
        Record_Type: In_Structure_Type :=
            Video_Encode_AV1_Rate_Control_Layer_Info_Type;
        Next: C.In_Structure_C_Access;
        Use_Min_Q_Index: Interfaces.Unsigned_32;
        Min_Q_Index: Extensions.KHR.Video_Encode_AV1_Q_Index;
        Use_Max_Q_Index: Interfaces.Unsigned_32;
        Max_Q_Index: Extensions.KHR.Video_Encode_AV1_Q_Index;
        Use_Max_Frame_Size: Interfaces.Unsigned_32;
        Max_Frame_Size: Extensions.KHR.Video_Encode_AV1_Frame_Size;
    end record
        with Convention => C;

    type Video_Encode_AV1_Rate_Control_Layer_Info_C_Access is
        access Video_Encode_AV1_Rate_Control_Layer_Info_C
        with Convention => C;
    ...
    type Video_Encode_Quantization_Map_Capabilities_C is
    record
        Record_Type: Out_Structure_Type :=
            Video_Encode_Quantization_Map_Capabilities_Type;
        Next: C.Out_Structure_C_Access;
    ...
    type Video_Encode_Quantization_Map_Capabilities_C_Access is
        access Video_Encode_Quantization_Map_Capabilities_C
        with Convention => C;
 
    type Video_Format_Quantization_Map_Properties_C is
    record
        Record_Type: Out_Structure_Type :=
            Video_Format_Quantization_Map_Properties_Type;
        Next: C.Out_Structure_C_Access;
    ...
    type Video_Format_Quantization_Map_Properties_C_Access is
        access Video_Format_Quantization_Map_Properties_C
        with Convention => C;

    type Video_Encode_Quantization_Map_Info_C is
    record
        Record_Type: In_Structure_Type :=
            Video_Encode_Quantization_Map_Info_Type;
        Next: C.In_Structure_C_Access;
    ...
    type Video_Encode_Quantization_Map_Info_C_Access is
        access Video_Encode_Quantization_Map_Info_C
        with Convention => C;

    type Video_Encode_Quantization_Map_Session_Parameters_Create_Info_C is
    record
        Record_Type: In_Structure_Type :=
            Video_Encode_Quantization_Map_Session_Parameters_Create_Info_Type;
        Next: C.In_Structure_C_Access;
    ...
    type Video_Encode_Quantization_Map_Session_Parameters_Create_Info_C_Access
        is access
            Video_Encode_Quantization_Map_Session_Parameters_Create_Info_C
        with Convention => C;

    type Physical_Device_Video_Encode_Quantization_Map_Features_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Video_Encode_Quantization_Map_Features_Type;
        Next: C.Out_Structure_C_Access;
        Video_Encode_Quantization_Map: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Video_Encode_Quantization_Map_Features_C_Access is
        access Physical_Device_Video_Encode_Quantization_Map_Features_C
        with Convention => C;

    type Video_Encode_H264_Quantization_Map_Capabilities_C is
    record
        Record_Type: Out_Structure_Type :=
            Video_Encode_H264_Quantization_Map_Capabilities_Type;
        Next: C.Out_Structure_C_Access;
        Min_QP_Delta: Interfaces.Integer_32;
        Max_QP_Delta: Interfaces.Integer_32;
    end record
        with Convention => C;

    type Video_Encode_H264_Quantization_Map_Capabilities_C_Access is
        access Video_Encode_H264_Quantization_Map_Capabilities_C
        with Convention => C;

    type Video_Encode_H265_Quantization_Map_Capabilities_C is
    record
        Record_Type: Out_Structure_Type :=
            Video_Encode_H265_Quantization_Map_Capabilities_Type;
        Next: C.Out_Structure_C_Access;
    ...
    type Video_Encode_H265_Quantization_Map_Capabilities_C_Access is
        access Video_Encode_H265_Quantization_Map_Capabilities_C
        with Convention => C;

    type Video_Format_H265_Quantization_Map_Properties_C is
    record
        Record_Type: Out_Structure_Type :=
            Video_Format_H265_Quantization_Map_Properties_Type;
        Next: C.Out_Structure_C_Access;
        Compatible_CTB_Sizes: Extensions.KHR.Video_Encode_H265_CTB_Size_Flags;
    end record
        with Convention => C;

    type Video_Format_H265_Quantization_Map_Properties_C_Access is
        access Video_Format_H265_Quantization_Map_Properties_C
        with Convention => C;

    type Video_Encode_AV1_Quantization_Map_Capabilities_C is
    record
        Record_Type: Out_Structure_Type :=
            Video_Encode_AV1_Quantization_Map_Capabilities_Type;
        Next: C.Out_Structure_C_Access;
        Min_Q_Index_Delta: Interfaces.Integer_32;
        Max_Q_Index_Delta: Interfaces.Integer_32;
    end record
        with Convention => C;

    type Video_Encode_AV1_Quantization_Map_Capabilities_C_Access is
        access Video_Encode_AV1_Quantization_Map_Capabilities_C
        with Convention => C;

    type Video_Format_AV1_Quantization_Map_Properties_C is
    record
        Record_Type: Out_Structure_Type :=
            Video_Format_AV1_Quantization_Map_Properties_Type;
        Next: C.Out_Structure_C_Access;
        Compatible_Superblock_Sizes:
            Extensions.KHR.Video_Encode_AV1_Superblock_Size_Flags;
    end record
        with Convention => C;

    type Video_Format_AV1_Quantization_Map_Properties_C_Access is
        access Video_Format_AV1_Quantization_Map_Properties_C
        with Convention => C;
 
    type Physical_Device_Shader_Relaxed_Extended_Instruction_Features_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Shader_Relaxed_Extended_Instruction_Features_Type;
        Next: C.Out_Structure_C_Access;
        Shader_Relaxed_Extended_Instruction: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Shader_Relaxed_Extended_Instruction_Features_C_Access
        is access
            Physical_Device_Shader_Relaxed_Extended_Instruction_Features_C
        with Convention => C;

    type Physical_Device_Maintenance_7_Features_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Maintenance_7_Features_Type;
        Next: C.Out_Structure_C_Access;
        Maintenance_7: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Maintenance_7_Features_C_Access is
        access Physical_Device_Maintenance_7_Features_C
        with Convention => C;

    type Physical_Device_Maintenance_7_Properties_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Maintenance_7_Properties_Type;
        Next: C.Out_Structure_C_Access;
        Robust_Fragment_Shading_Rate_Attachment_Access: Interfaces.Unsigned_32;
        Separate_Depth_Stencil_Attachment_Access: Interfaces.Unsigned_32;
        Max_Descriptor_Set_Total_Uniform_Buffers_Dynamic:
            Interfaces.Unsigned_32;
        Max_Descriptor_Set_Total_Storage_Buffers_Dynamic:
            Interfaces.Unsigned_32;
        Max_Descriptor_Set_Total_Buffers_Dynamic: Interfaces.Unsigned_32;
    ...
    type Physical_Device_Maintenance_7_Properties_C_Access is
        access Physical_Device_Maintenance_7_Properties_C
        with Convention => C;

    type Physical_Device_Layered_API_Properties_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Layered_API_Properties_Type;
        Next: C.Out_Structure_C_Access;
        ...
        Layered_API: Extensions.KHR.Physical_Device_Layered_API;
        Device_Name: Interfaces.C.char_array
            (1 .. Max_Physical_Device_Name_Size);
    end record
        with Convention => C;

    type Physical_Device_Layered_API_Properties_C_Access is
        access Physical_Device_Layered_API_Properties_C
        with Convention => C;

    package Physical_Device_Layered_API_Properties_C_Arrays is
        new C_Arrays(Physical_Device_Layered_API_Properties_C);

    type Physical_Device_Layered_API_Properties_List_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Layered_API_Properties_List_Type;
        Next: C.Out_Structure_C_Access;
        Layered_API_Count: Interfaces.Unsigned_32;
        Layered_APIs: Physical_Device_Layered_API_Properties_C_Arrays.Pointer;
    end record
        with Convention => C;

    type Physical_Device_Layered_API_Properties_List_C_Access is
        access Physical_Device_Layered_API_Properties_List_C
        with Convention => C;

    type Physical_Device_Layered_API_Vulkan_Properties_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Layered_API_Vulkan_Properties_Type;
        Next: C.Out_Structure_C_Access;
        Properties: C_V1_1.Physical_Device_Properties_2_C;
    end record
        with Convention => C;

    type Physical_Device_Layered_API_Vulkan_Properties_C_Access is
        access Physical_Device_Layered_API_Vulkan_Properties_C
        with Convention => C;

    type Physical_Device_Maintenance_8_Features_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Maintenance_8_Features_Type;
        Next: C.Out_Structure_C_Access;
        Maintenance_8: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Maintenance_8_Features_C_Access is
        access Physical_Device_Maintenance_8_Features_C
        with Convention => C;

    type Memory_Barrier_Access_Flags_3_C is
    record
        Record_Type: In_Structure_Type := Memory_Barrier_Access_Flags_3_Type;
        Next: C.In_Structure_C_Access;
        Src_Access_Mask_3: Extensions.KHR.Access_Flags_3;
        Dst_Access_Mask_3: Extensions.KHR.Access_Flags_3;
    end record
        with Convention => C;

    type Memory_Barrier_Access_Flags_3_C_Access is
        access Memory_Barrier_Access_Flags_3_C
        with Convention => C;

    type Physical_Device_Video_Maintenance_2_Features_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Video_Maintenance_2_Features_Type;
        Next: C.Out_Structure_C_Access;
        Video_Maintenance_2: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Video_Maintenance_2_Features_C_Access is
        access Physical_Device_Video_Maintenance_2_Features_C
        with Convention => C;

    type Video_Decode_H264_Inline_Session_Parameters_Info_C is
    record
        Record_Type: In_Structure_Type :=
            Video_Decode_H264_Inline_Session_Parameters_Info_Type;
        Next: C.In_Structure_C_Access;
        Std_SPS: Extensions.Std_Video.H264.Sequence_Parameter_Set_Access;
        Std_PPS: Extensions.Std_Video.H264.Picture_Parameter_Set_Access;
    end record
        with Convention => C;

    type Video_Decode_H264_Inline_Session_Parameters_Info_C_Access is
        access Video_Decode_H264_Inline_Session_Parameters_Info_C
        with Convention => C;

    type Video_Decode_H265_Inline_Session_Parameters_Info_C is
    record
        Record_Type: In_Structure_Type :=
            Video_Decode_H265_Inline_Session_Parameters_Info_Type;
        Next: C.In_Structure_C_Access;
        Std_VPS: Extensions.Std_Video.H265.Video_Parameter_Set_Access;
        Std_SPS: Extensions.Std_Video.H265.Sequence_Parameter_Set_Access;
        Std_PPS: Extensions.Std_Video.H265.Picture_Parameter_Set_Access;
    end record
        with Convention => C;

    type Video_Decode_H265_Inline_Session_Parameters_Info_C_Access is
        access Video_Decode_H265_Inline_Session_Parameters_Info_C
        with Convention => C;

    type Video_Decode_AV1_Inline_Session_Parameters_Info_C is
    record
        Record_Type: In_Structure_Type :=
            Video_Decode_AV1_Inline_Session_Parameters_Info_Type;
        Next: C.In_Structure_C_Access;
    ...
    type Video_Decode_AV1_Inline_Session_Parameters_Info_C_Access is
        access Video_Decode_AV1_Inline_Session_Parameters_Info_C
        with Convention => C;

    type Physical_Device_Depth_Clamp_Zero_One_Features_C is
    record
        Record_Type: Out_Structure_Type :=
            Physical_Device_Depth_Clamp_Zero_One_Features_Type;
        Next: C.Out_Structure_C_Access;
        Depth_Clamp_Zero_One: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Physical_Device_Depth_Clamp_Zero_One_Features_C_Access is
        access Physical_Device_Depth_Clamp_Zero_One_Features_C
        with Convention => C;

    type Device_Or_Host_Address_C
        (Address_Type: Extensions.KHR.Address_Type := Extensions.KHR.Device) is
    record
    ...
    type Android_Surface_Create_Info_C is
    record
        Record_Type: In_Structure_Type := Android_Surface_Create_Info_Type;
        Next: C.In_Structure_C_Access;
        Flags: Extensions.KHR.Android_Surface_Create_Flags;
        Window: Android.Native_Window;
    end record
        with Convention => C;

    type Android_Surface_Create_Info_C_Access is
        access Android_Surface_Create_Info_C
        with Convention => C;
   ...
   Extensions.KHR.Physical_Device_Shader_Subgroup_Uniform_Control_Flow_Features;
    ...
    procedure To_Ada
        (Ada_Struct: in out
         ...
         C_Struct: in Physical_Device_Pipeline_Binary_Features_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Physical_Device_Pipeline_Binary_Properties;
         C_Struct: in Physical_Device_Pipeline_Binary_Properties_C);

    function To_C
        (Struct: in
            Extensions.KHR.Device_Pipeline_Binary_Internal_Cache_Control)
        return Device_Pipeline_Binary_Internal_Cache_Control_C;
    procedure Free
        (Struct: in out Device_Pipeline_Binary_Internal_Cache_Control_C);

    procedure To_Ada(Ada_Struct: in out Extensions.KHR.Pipeline_Binary_Key;
                     C_Struct: in Pipeline_Binary_Key_C);

    function To_C(Struct: in Extensions.KHR.Pipeline_Binary_Keys_And_Data)
        return Pipeline_Binary_Keys_And_Data_C;
    procedure Free(Struct: in out Pipeline_Binary_Keys_And_Data_C);

    function To_C(Struct: in Extensions.KHR.Pipeline_Create_Info)
        return Pipeline_Create_Info_C;
    procedure Free(Struct: in out Pipeline_Create_Info_C);

    function To_C(Struct: in Extensions.KHR.Pipeline_Binary_Create_Info)
        return Pipeline_Binary_Create_Info_C;
    procedure Free(Struct: in out Pipeline_Binary_Create_Info_C);
                  
    function To_C(Struct: in Extensions.KHR.Pipeline_Binary_Info)
        return Pipeline_Binary_Info_C;
    procedure Free(Struct: in out Pipeline_Binary_Info_C);

    procedure To_Ada
        (Ada_Struct: in out Extensions.KHR.Release_Captured_Pipeline_Data_Info;
         C_Struct: in Release_Captured_Pipeline_Data_Info_C);

    procedure To_Ada
        (Ada_Struct: in out Extensions.KHR.Pipeline_Binary_Data_Info;
         C_Struct: in Pipeline_Binary_Data_Info_C);

    function To_C(Struct: in Extensions.KHR.Pipeline_Binary_Handles_Info)
        return Pipeline_Binary_Handles_Info_C;
    procedure Free(Struct: in out Pipeline_Binary_Handles_Info_C);
    ...
    procedure To_Ada
        (Ada_Struct: in out
         ...
         C_Struct: in Physical_Device_Compute_Shader_Derivatives_Features_C);

    procedure To_Ada
        (Ada_Struct: in out
           Extensions.KHR.Physical_Device_Compute_Shader_Derivatives_Properties;
         C_Struct: in Physical_Device_Compute_Shader_Derivatives_Properties_C);
    ...
    procedure To_Ada
        (Ada_Struct: in out
         ...
         C_Struct: in Physical_Device_Video_Encode_AV1_Features_C);

    procedure To_Ada
        (Ada_Struct: in out Extensions.KHR.Video_Encode_AV1_Capabilities;
         C_Struct: in Video_Encode_AV1_Capabilities_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Video_Encode_AV1_Quality_Level_Properties;
         C_Struct: in Video_Encode_AV1_Quality_Level_Properties_C);

    function To_C
        (Struct: in Extensions.KHR.Video_Encode_AV1_Session_Create_Info)
        return Video_Encode_AV1_Session_Create_Info_C;
    procedure Free(Struct: in out Video_Encode_AV1_Session_Create_Info_C);

    function To_C
        (Struct: in
            Extensions.KHR.Video_Encode_AV1_Session_Parameters_Create_Info)
        return Video_Encode_AV1_Session_Parameters_Create_Info_C;
    procedure Free
        (Struct: in out Video_Encode_AV1_Session_Parameters_Create_Info_C);

    function To_C(Struct: in Extensions.KHR.Video_Encode_AV1_Picture_Info)
        return Video_Encode_AV1_Picture_Info_C;
    procedure Free(Struct: in out Video_Encode_AV1_Picture_Info_C);

    function To_C(Struct: in Extensions.KHR.Video_Encode_AV1_DPB_Slot_Info)
        return Video_Encode_AV1_DPB_Slot_Info_C;
    procedure Free(Struct: in out Video_Encode_AV1_DPB_Slot_Info_C);

    function To_C(Struct: in Extensions.KHR.Video_Encode_AV1_Profile_Info)
        return Video_Encode_AV1_Profile_Info_C;
    procedure Free(Struct: in out Video_Encode_AV1_Profile_Info_C);

    function To_C
        (Struct: in Extensions.KHR.Video_Encode_AV1_GOP_Remaining_Frame_Info)
        return Video_Encode_AV1_GOP_Remaining_Frame_Info_C;
    procedure Free(Struct: in out Video_Encode_AV1_GOP_Remaining_Frame_Info_C);

    function To_C(Struct: in Extensions.KHR.Video_Encode_AV1_Rate_Control_Info)
        return Video_Encode_AV1_Rate_Control_Info_C;
    procedure Free(Struct: in out Video_Encode_AV1_Rate_Control_Info_C);

    function To_C
        (Struct: in Extensions.KHR.Video_Encode_AV1_Rate_Control_Layer_Info)
        return Video_Encode_AV1_Rate_Control_Layer_Info_C;
    procedure Free(Struct: in out Video_Encode_AV1_Rate_Control_Layer_Info_C);
    ...
    procedure To_Ada
        (Ada_Struct: in out
         ...
         C_Struct: in Video_Encode_Quantization_Map_Capabilities_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Video_Format_Quantization_Map_Properties;
         C_Struct: in Video_Format_Quantization_Map_Properties_C);

    function To_C(Struct: in Extensions.KHR.Video_Encode_Quantization_Map_Info)
        return Video_Encode_Quantization_Map_Info_C;
    procedure Free(Struct: in out Video_Encode_Quantization_Map_Info_C);

    function To_C
        (Struct: in
    Extensions.KHR.Video_Encode_Quantization_Map_Session_Parameters_Create_Info)
        return Video_Encode_Quantization_Map_Session_Parameters_Create_Info_C;
    procedure Free
        (Struct: in out
            Video_Encode_Quantization_Map_Session_Parameters_Create_Info_C);
    ...
    procedure To_Ada
        (Ada_Struct: in out
         ...
         C_Struct: in Physical_Device_Video_Encode_Quantization_Map_Features_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Video_Encode_H264_Quantization_Map_Capabilities;
         C_Struct: in Video_Encode_H264_Quantization_Map_Capabilities_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Video_Encode_H265_Quantization_Map_Capabilities;
         C_Struct: in Video_Encode_H265_Quantization_Map_Capabilities_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Video_Format_H265_Quantization_Map_Properties;
         C_Struct: in Video_Format_H265_Quantization_Map_Properties_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Video_Encode_AV1_Quantization_Map_Capabilities;
         C_Struct: in Video_Encode_AV1_Quantization_Map_Capabilities_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Video_Format_AV1_Quantization_Map_Properties;
         C_Struct: in Video_Format_AV1_Quantization_Map_Properties_C);
    ...
    procedure To_Ada
        (Ada_Struct: in out
         ...
         C_Struct: in Physical_Device_Maintenance_7_Features_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Physical_Device_Maintenance_7_Properties;
         C_Struct: in Physical_Device_Maintenance_7_Properties_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Physical_Device_Layered_API_Properties;
         C_Struct: in Physical_Device_Layered_API_Properties_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Physical_Device_Layered_API_Properties_List;
         C_Struct: in Physical_Device_Layered_API_Properties_List_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Physical_Device_Layered_API_Vulkan_Properties;
         C_Struct: in Physical_Device_Layered_API_Vulkan_Properties_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Physical_Device_Maintenance_8_Features;
         C_Struct: in Physical_Device_Maintenance_8_Features_C);

    function To_C(Struct: in Extensions.KHR.Memory_Barrier_Access_Flags_3)
        return Memory_Barrier_Access_Flags_3_C;
    procedure Free(Struct: in out Memory_Barrier_Access_Flags_3_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Physical_Device_Video_Maintenance_2_Features;
         C_Struct: in Physical_Device_Video_Maintenance_2_Features_C);

    function To_C
        (Struct: in
            Extensions.KHR.Video_Decode_H264_Inline_Session_Parameters_Info)
        return Video_Decode_H264_Inline_Session_Parameters_Info_C;
    procedure Free
        (Struct: in out Video_Decode_H264_Inline_Session_Parameters_Info_C);

    function To_C
        (Struct: in
            Extensions.KHR.Video_Decode_H265_Inline_Session_Parameters_Info)
        return Video_Decode_H265_Inline_Session_Parameters_Info_C;
    procedure Free
        (Struct: in out Video_Decode_H265_Inline_Session_Parameters_Info_C);

    function To_C
        (Struct: in
            Extensions.KHR.Video_Decode_AV1_Inline_Session_Parameters_Info)
        return Video_Decode_AV1_Inline_Session_Parameters_Info_C;
    procedure Free
        (Struct: in out Video_Decode_AV1_Inline_Session_Parameters_Info_C);

    procedure To_Ada
        (Ada_Struct: in out
            Extensions.KHR.Physical_Device_Depth_Clamp_Zero_One_Features;
         C_Struct: in Physical_Device_Depth_Clamp_Zero_One_Features_C);

    procedure To_C(C_Address: out Device_Or_Host_Address_C;
                   Ada_Address: in Extensions.KHR.Device_Or_Host_Address);
    ...
    function To_C(Struct: in Extensions.KHR.Android_Surface_Create_Info)
        return Android_Surface_Create_Info_C;
    procedure Free(Struct: in out Android_Surface_Create_Info_C);
