...
package body Vulkan.Extensions.NVX_Image_View_Handle is
    -- Loaded extension functions.
    type vkGetImageViewHandleNVX_Access is
        access function(Device: in Vulkan.Device;
                        Info: in C_NVX.Image_View_Handle_Info_C)
    ...
    type vkGetImageViewAddressNVX_Access is
        access function
            (Device: in Vulkan.Device;
             ...
             Properties: in C_NVX.Image_View_Address_Properties_C)
        return Result
        with Convention => C;
    ...
    function Get_Image_View_Handle(Device: in Vulkan.Device;
        ...
        Info_C: C_NVX.Image_View_Handle_Info_C := C_NVX.To_C(Info);
    ...
    function Get_Image_View_Address
        (Device: in Vulkan.Device;
         Image_View: in Vulkan.Image_View;
         Properties: in out NVX.Image_View_Address_Properties) return Result is
        Properties_C: C_NVX.Image_View_Address_Properties_C;
    ...
    begin
        ...
        C_NVX.To_Ada(Properties, Properties_C);
    ...
    procedure Get_Image_View_Address
        (Device: in Vulkan.Device;
         Image_View: in Vulkan.Image_View;
         Properties: in out NVX.Image_View_Address_Properties) is
    begin
    ...
    function Get_Image_View_Address(Device: in Vulkan.Device;
                                    Image_View: in Vulkan.Image_View)
        return NVX.Image_View_Address_Properties is
        Properties: NVX.Image_View_Address_Properties;
    begin
