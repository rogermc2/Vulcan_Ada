...
-- Common constants and types for AV1 encode extensions

package Vulkan.Extensions.Std_Video.AV1.Encode is
    -- Records.
    type Decoder_Model_Info is
    record
        Buffer_Delay_Length_Minus_1: Interfaces.Unsigned_8;
        Buffer_Removal_Time_Length_Minus_1: Interfaces.Unsigned_8;
        Frame_Presentation_Time_Length_Minus_1: Interfaces.Unsigned_8;
        Reserved_1: Interfaces.Unsigned_8;
        Num_Units_In_Decoding_Tick: Interfaces.Unsigned_32;
    end record
        with Convention => C;

    type Decoder_Model_Info_Access is access constant Decoder_Model_Info
        with Convention => C,
             Storage_Size => 0;

    type Extension_Header is
    record
        Temporal_ID: Interfaces.Unsigned_8;
        Spatial_ID: Interfaces.Unsigned_8;
    end record
        with Convention => C;

    type Extension_Header_Access is access constant Extension_Header
        with Convention => C,
             Storage_Size => 0;

    type Operating_Point_Info_Flags is
    record
        Decoder_Model_Present_For_This_Op: Packed_Bit := 0;
        Low_Delay_Mode_Flag: Packed_Bit := 0;
        Initial_Display_Delay_Present_For_This_Op: Packed_Bit := 0;
        Reserved: Packed_Bit := 0;
    end record
        with Convention => C;

    for Operating_Point_Info_Flags use
    record
        Decoder_Model_Present_For_This_Op at 0 range 0 .. 0;
        Low_Delay_Mode_Flag at 0 range 1 .. 1;
        Initial_Display_Delay_Present_For_This_Op at 0 range 2 .. 2;
        Reserved at 0 range 3 .. 31;
    end record;

    type Operating_Point_Info is
    record
        Flags: Operating_Point_Info_Flags;
        Operating_Point_IDC: Interfaces.Unsigned_16;
        Seq_Level_IDX: Interfaces.Unsigned_8;
        Seq_Tier: Interfaces.Unsigned_8;
        Decoder_Buffer_Delay: Interfaces.Unsigned_32;
        Encoder_Buffer_Delay: Interfaces.Unsigned_32;
        Initial_Display_Delay_Minus_1: Interfaces.Unsigned_8;
    end record
        with Convention => C;

    package Operating_Point_Info_Vectors is
        new Ada.Containers.Vectors(Positive, Operating_Point_Info);
    ...
    record
        ...
        Show_Frame: Packed_Bit := 0;
        Showable_Frame: Packed_Bit := 0;
        Reserved: Packed_Bit := 0;
    end record
        with Convention => C;
    ...
    record
        ...
        Skip_Mode_Present at 0 range 17 .. 17;
        Delta_Q_Present at 0 range 18 .. 18;
        Delta_LF_Present at 0 range 19 .. 19;
        Delta_LF_Multi at 0 range 20 .. 20;
        Segmentation_Enabled at 0 range 21 .. 21;
        Segmentation_Update_Map at 0 range 22 .. 22;
        Segmentation_Temporal_Update at 0 range 23 .. 23;
        Segmentation_Update_Data at 0 range 24 .. 24;
        Uses_LR at 0 range 25 .. 25;
        Uses_Chroma_LR at 0 range 26 .. 26;
        Show_Frame at 0 range 27 .. 27;
        Showable_Frame at 0 range 28 .. 28;
        Reserved at 0 range 29 .. 31;
    end record;

    type Delta_Frame_ID_Array is
        array (1 .. Refs_Per_Frame) of Interfaces.Unsigned_32
        with Convention => C;
    ...
    record
        ...
        Frame_Presentation_Time: Interfaces.Unsigned_32;
        ...
        Render_Width_Minus_1: Interfaces.Unsigned_16;
        Render_Height_Minus_1: Interfaces.Unsigned_16;
        Interpolation_Filter: AV1.Interpolation_Filter;
        Tx_Mode: AV1.Tx_Mode;
        Delta_Q_Res: Interfaces.Unsigned_8;
        Delta_LF_Res: Interfaces.Unsigned_8;
        Ref_Order_Hint: Ref_Frames_Array;
        Ref_Frame_IDX: Total_Refs_Per_Frame_Array;
        Reserved_1: Reserved_Array(1 .. 3);
        Delta_Frame_ID_Minus_1: Delta_Frame_ID_Array;
        ...
        Extension_Header: Extension_Header_Access;
        Buffer_Removal_Times: access constant Interfaces.Unsigned_32;
    end record
        with Convention => C;
    ...
    record
        ...
        Ref_Frame_ID: Interfaces.Unsigned_32;
        Frame_Type: AV1.Frame_Type;
        Order_Hint: Interfaces.Unsigned_8;
        Reserved_1: Reserved_Array(1 .. 3);
        Extension_Header: Encode.Extension_Header_Access;
    end record
        with Convention => C;
    ...
    type Reference_Info_Access is access constant Reference_Info
        with Convention => C,
             Storage_Size => 0;
end Vulkan.Extensions.Std_Video.AV1.Encode;
