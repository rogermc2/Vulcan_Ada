...
package Vulkan.Extensions.Std_Video.H265 is
    ...
    type Video_Parameter_Set_Access is access constant Video_Parameter_Set
        with Convention => C,
             Storage_Size => 0;
    ...
    type Sequence_Parameter_Set_Access is access constant Sequence_Parameter_Set
        with Convention => C,
             Storage_Size => 0;
    ...
    type Picture_Parameter_Set_Access is access constant Picture_Parameter_Set
        with Convention => C,
             Storage_Size => 0;
