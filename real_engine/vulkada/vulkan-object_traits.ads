...
package Vulkan.Object_Traits is
    ...
    package Deferred_Operation is new Traits
        (Extensions.KHR.Deferred_Operation,
         Deferred_Operation_Object_Type,
         Extensions.KHR.No_Deferred_Operation);
    package Pipeline_Binary is new Traits(Extensions.KHR.Pipeline_Binary,
                                          Pipeline_Binary_Object_Type,
                                          Extensions.KHR.No_Pipeline_Binary);
    package Acceleration_Structure is new Traits
        (Extensions.KHR.Acceleration_Structure,
         Acceleration_Structure_KHR_Object_Type,
         Extensions.KHR.No_Acceleration_Structure);
    package Acceleration_Structure_NV is new Traits
        (Extensions.NV.Acceleration_Structure,
         Acceleration_Structure_NV_Object_Type,
         Extensions.NV.No_Acceleration_Structure);
    package Indirect_Commands_Layout is new Traits
        (Extensions.NV.Indirect_Commands_Layout,
         Indirect_Commands_Layout_NV_Object_Type,
         Extensions.NV.No_Indirect_Commands_Layout);
    package CUDA_Module is new Traits
        (Extensions.NV.CUDA_Module,
         CUDA_Module_Object_Type,
         Extensions.NV.No_CUDA_Module);
    package CUDA_Function is new Traits
        (Extensions.NV.CUDA_Function,
         CUDA_Function_Object_Type,
         Extensions.NV.No_CUDA_Function);
    ...
    package Validation_Cache is new Traits
        (Extensions.EXT.Validation_Cache,
         Validation_Cache_Object_Type,
         Extensions.EXT.No_Validation_Cache);
    package Micromap is new Traits(Extensions.EXT.Micromap,
                                   Micromap_Object_Type,
                                   Extensions.EXT.No_Micromap);
    package Performance_Configuration is new Traits
        (Extensions.INTEL.Performance_Configuration,
         Performance_Configuration_Object_Type,
         Extensions.INTEL.No_Performance_Configuration);
