...
package body Vulkan.Utilities is
    ...
    procedure To_C_Array(C_Count: out Interfaces.Unsigned_32;
        ...
        procedure Implementation is
            new To_C_Array_Count_Type(Interfaces.Unsigned_32, C_Array, Vectors);
    begin
        Implementation(C_Count, Vector, C_Pointer);
    end To_C_Array;
    ...
    procedure To_C_Array_Count_Type(C_Count: out Count_Type;
                                    Vector: in Vectors.Vector;
                                    C_Pointer: out C_Array.Pointer) is
    begin
        C_Count := Count_Type(Vector.Length);
