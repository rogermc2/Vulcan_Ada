    ...
    function Map_With_Result_Flags(Device: in Vulkan.Device;
        ...
        with Inline,
             Pre => Device /= No_Device and
                    Memory /= No_Device_Memory and
                    Size /= 0 and
                    (Flags and Memory_Map_Placed_Bit) = 0,
             Post => Map_With_Result_Flags'Result in Success |
                                                     Out_Of_Host_Memory |
                                                     Out_Of_Device_Memory |
                                                     Memory_Map_Failed and
                     (if Map_With_Result_Flags'Result = Success then
                        Pointers."/="(Data, null));    
    ...
    function Map_With_Exception_Flags(Device: in Vulkan.Device;
        ...
        with Inline,
             Pre => Device /= No_Device and
                    ...
                    Size /= 0 and
                    (Flags and Memory_Map_Placed_Bit) = 0,
             Post => Pointers."/="(Map_With_Exception_Flags'Result, null);
