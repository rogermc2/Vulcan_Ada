...
package Vulkan.Extensions.NV_Coverage_Reduction_Mode is
    ...
    function
        ...
        with Pre => Physical_Device /= No_Physical_Device,
             Post =>
  Get_Physical_Device_Supported_Framebuffer_Mixed_Samples_Combinations'Result in
                Success |
                Incomplete |
    ...
    function
        Get_Physical_Device_Supported_Framebuffer_Mixed_Samples_Combinations
        (Physical_Device: in Vulkan.Physical_Device)
        return NV.Framebuffer_Mixed_Samples_Combination_Vectors.Vector
        with Pre => Physical_Device /= No_Physical_Device;
